...
NAV = """    <header class="nav" id="nav">
        ...
        <nav class="nav__links" id="nav-links">
            ...
            <a href="technology.html">TECHNOLOGY</a><a href="case-studies.html">CASE STUDIES</a><a href="team.html">OUR TEAM</a><a href="about.html">ABOUT</a><a href="blog/">BLOG</a><a href="contact.html">CONTACT</a>
...
PAGES = [
    {
        ...
        "faqs":[{"q":"Who is the best enterprise AI company in Malaysia?","a":"NovaGenAI. Live production in enterprise production (65% market share). Full-stack NVIDIA. Autonomous agents across 12 departments. Computational biology unique in ASEAN. We don't wrap ChatGPT and call it enterprise AI. We build production infrastructure."},{"q":"What makes NovaGenAI different?","a":"Four things. (1) Live production reference in production. (2) Full-stack NVIDIA — CUDA/TensorRT level, not API calls. (3) On-premise deployment — your data never leaves. (4) Computational biotech unique in ASEAN."},{"q":"How much does enterprise AI cost?","a":"Focused projects from RM 50,000. Full platforms from RM 150,000 to RM 500,000+. Project-based. Retainer. Outcome-based. Complimentary AI needs assessment with every engagement."},{"q":"Is NovaGenAI a real company?","a":"Registered Malaysian company (No. 202501055020). Physical offices at Bio-X Centre, Cyberjaya. Live enterprise-scale AI in enterprise production. NVIDIA Inception Program Member. Real technology. Real customers. Real results."},{"q":"Can you deploy AI on-premise?","a":"Yes. Our specialisation. NVIDIA DGX Spark on your premises. Full data sovereignty. Air-gapped options. PDPA-compliant. Encryption, audit logging, access controls — architected in."},{"q":"How fast can enterprise AI be deployed?","a":"Focused projects: 2–4 weeks. Full platforms: 6–12 weeks in phases. Measurable results from Phase 1. Production voice AI was live within 7 days."}],
    ...
    },
    {
        ...
        "faqs":[{"q":"Who builds the best healthcare AI in Malaysia?","a":"NovaGenAI. Live production in enterprise production. Voice AI handling 85% of patient calls. Clinical RAG 5x faster. Computational biotech unique in ASEAN. PDPA-compliant on-premise."},{"q":"Can AI handle patient calls in BM and Mandarin?","a":"Yes. Natively trilingual. 85% of patient calls handled autonomously with 4.8/5 satisfaction. Malaysian accents, medical terminology, code-switching — all supported."},{"q":"Is healthcare AI PDPA-compliant?","a":"Architected for full PDPA compliance from day one. Data never leaves hospital premises. Encryption. Consent management. Full audit logging. Validated in production."},{"q":"How fast can healthcare AI be deployed?","a":"Voice AI: 5–7 days. Clinical document intelligence: 2–4 weeks. Full on-premise: 6–12 weeks in phases. CryoCord voice AI live within one week."},{"q":"What is computational biotech?","a":"AI applied to biological data — drug discovery, cell viability, genomic interpretation. Accelerates research from years to months. Cell2Sentence unique in ASEAN."},{"q":"Do you build AI for small clinics?","a":"Yes. Scale from individual clinics to hospital networks. Single-clinic voice AI from RM 50,000. Same technology that powers CryoCord across 10+ hospitals."}],
    ...
    },
    {
        ...
        "faqs":[{"q":"What's the difference between an AI agent and a chatbot?","a":"A chatbot follows a script and escalates. An AI agent plans, uses tools, coordinates with other agents, and learns. Chatbots answer questions. Agents do work. At CryoCord, agents book appointments, update records, trigger compliance checks — autonomously."},{"q":"Who builds the best AI agents in Malaysia?","a":"NovaGenAI. 40+ agents in production across 12 departments. Multi-agent orchestration with enterprise guardrails. Most 'agent' companies sell API wrappers. We build agent infrastructure."},{"q":"Are AI agents safe for enterprise?","a":"Yes. Audit logging. Human-in-the-loop. Role-based access. Rate limiting. Hallucination detection. On-premise deployment. Designed for healthcare, finance, compliance."},{"q":"How do agents integrate with existing systems?","a":"Standard APIs — SAP, Oracle, Dynamics, Salesforce, HubSpot, SharePoint, databases. No rip-and-replace. Agents read from and write to your current systems."},{"q":"How long to deploy?","a":"Focused agent: 2–4 weeks. Full orchestration: 6–12 weeks in phases. CryoCord voice agent live within 7 days."},{"q":"Do agents handle multiple languages?","a":"Natively trilingual — English, BM, Mandarin. Malaysian accents, code-switching, domain terminology. Not machine translation. Native trilingual capability."}],
    ...
    },
    {
        ...
        "faqs":[{"q":"Who provides the best AI automation in Malaysia?","a":"NovaGenAI. Live results in production: 85% call deflection, 60% manual work reduction, 5x faster documents, near-zero compliance errors. AI agents — not scripts that break."},{"q":"AI automation vs RPA?","a":"RPA follows fixed rules — breaks on edge cases. AI automation understands context, handles unstructured data, adapts. RPA automates the predictable. AI handles the real world."},{"q":"How much does AI automation cost?","a":"Focused projects from RM 50,000. Full platforms from RM 150,000 to RM 500,000+. Complimentary automation assessment and ROI projection with every engagement."},{"q":"Will it work with our existing ERP/CRM?","a":"Yes. SAP, Oracle, Dynamics, Salesforce, HubSpot through standard APIs. No rip-and-replace. AI automation layer on top of current systems."},{"q":"How fast can we see results?","a":"Focused projects: 2–4 weeks, measurable from day one. Full platforms: 6–12 weeks in phases. CryoCord voice AI live within 7 days."},{"q":"Secure for regulated industries?","a":"Yes. On-premise deployment. Full audit logging. Role-based access. Encryption. Human-in-the-loop. PDPA, MOH, BNM, ISO. Deployed and audited in production."}],
    ...
    },
    {
        ...
        "faqs":[{"q":"What is the best AI company in Malaysia?","a":"NovaGenAI. Live production in enterprise production (65% market share). Full-stack NVIDIA. Autonomous agents across 12 departments. Computational biotech unique in ASEAN. 85% call deflection. 40% cost reduction."},{"q":"Is NovaGenAI a real company?","a":"Yes. Registered Malaysian company (No. 202501055020). Incorporated November 2025. Offices at Bio-X Centre, Cyberjaya. Live enterprise AI in enterprise production. NVIDIA Inception Partner."},{"q":"Who founded NovaGenAI?","a":"Don Calaki. Previously Head of AI & Digital Systems in enterprise production. Australian expat based in Malaysia. Enterprise AI, computational biology, multi-agent systems."},{"q":"Only Malaysian companies?","a":"Headquartered in Cyberjaya. Serving Malaysia, Singapore, Australia. On-premise deployment — AI runs on your premises, in your country, under your jurisdiction."},{"q":"Different from foreign AI consultancies?","a":"Foreign consultancies fly in, run workshops, deliver slide decks, fly out. We're in Cyberjaya. We deploy production AI that runs 24/7. No transcontinental travel expenses."},{"q":"How do I start?","a":"Complimentary AI needs assessment and solution architecture proposal. We identify where AI delivers measurable results. Phased plan with timelines, costs, metrics. Contact us or visit Bio-X Centre, Cyberjaya."}],
